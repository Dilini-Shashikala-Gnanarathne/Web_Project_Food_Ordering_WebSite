...
import { pageStyle, spacedTextStyle, imageContainerStyle, adminIcon, addminP, buttonIcon, column2WrapperStyle, A_P_3_images, A_P_3_logout, A_P_3_icon1, A_P_3_icon2, Column2WrapperRow, footerTextStyle1, footerTextStyle2 } from './AdminPage1.jsx';
  ...
  return (
    <div style={pageStyle}>
      ...
      <div id='A_P_3_images' style={{ ...A_P_3_images }}>
        <img src={gen_X} alt="gen_x Image" style={{ ...A_P_3_images }} />
